...
export const DATA = {
  ...
  experience: {
    ...
    edu: [
      { org: 'Université (À Mettre à Jour)', date: '2020 — 2022', role: { fr: 'Master en Data Science & Intelligence Artificielle', en: 'Master’s Degree in Data Science & AI' }, bullets: { fr: ['Machine Learning avancé, Modèles statistiques.', 'Thèse sur l’application des réseaux de neurones (NLP).'], en: ['Advanced Machine Learning, Statistical modeling.', 'Thesis on Neural Networks applications in NLP.'] } },
      { org: 'Université (À Mettre à Jour)', date: '2017 — 2020', role: { fr: 'Licence en Statistiques et Informatique Décisionnelle', en: 'Bachelor’s in Statistics & Business Intelligence' }, bullets: { fr: ['Analyse de données, Algorithmique, Programmation R & Python.', 'Bases de données SQL et modélisation mathématique.'], en: ['Data analysis, Algorithms, R & Python programming.', 'SQL databases and mathematical modeling.'] } },
      { org: 'Coursera / AWS (À Mettre à Jour)', date: '2023', role: { fr: 'Certifications Spécialisées', en: 'Specialized Certifications' }, bullets: { fr: ['DeepLearning.AI: Prompt Engineering for Developers.', 'IBM Data Science Professional Certificate.'], en: ['DeepLearning.AI: Prompt Engineering for Developers.', 'IBM Data Science Professional Certificate.'] } },
    ],
  },
